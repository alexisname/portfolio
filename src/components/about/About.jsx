        ...
        <div className="about__content">
          <div className="about__cards">
            <article className='about__card'>
              ...
              <h5>Experience</h5>
              <small>7+ Years Working in International Company</small>
            </article>

            <article className='about__card'>
              <FiUsers className='about__icon'/>
              <h5>Credentials</h5>
              <small>Master of Science in Applied Computer Science (Advaced Computer Programming)</small>
            </article>
